									...
									@foreach($portfolios as $k=>$item)
										...
										@if($k==0)
				                            ...
				                            <div class="work-overlay">
				                                <h3><a href="{{ route('portfolios.show', ['portfolios' => $item->alias]) }}">{{ $item->title }}</a></h3>
				                                <p class="work-overlay-categories"><img src="{{ asset(env('THEME')) }}/images/categories.png" alt="Categories" /> in: <a href="{{ route('portfolios.show', ['portfolios' => $item->alias]) }}">{{ $item->filter->title }}</a></p>
				                            </div>
				                        </div>
				                        <div class="work-description">
				                            ...
				                            {{ str_limit($item->text, 200) }}
				                                ...
				                                <a href="{{ route('portfolios.show', ['portfolios' => $item->alias]) }}" class="read-more">|| Read more</a>
				                        </div>
				                    </div>
				                            ...
				                            <div class="overlay_a related_img">
				                                <div class="overlay_wrapper">
				                                    ...
				                                    <div class="overlay">
				                                        ...
				                                        <a class="overlay_project" href="{{ route('portfolios.show', ['portfolios' => $item->alias]) }}"></a>
				                                        <span class="overlay_title">{{ $item->title }}</span>
				                                    </div>
				                                </div>
				                            </div>
				                            <h4><a href="{{ route('portfolios.show', ['portfolios' => $item->alias]) }}">{{ $item->title }}</a></h4>
